...
public class c1_Introduction extends IntroductionBase {
    ...
    public void nothing_happens_until_you_() throws InterruptedException {
        ...
        serviceResult
                ...
                .blockLast() //todo: add an operator here, don't use any blocking operator!
        ;
    ...
    public void leaving_blocking_world_behind() throws InterruptedException {
        ...
        fortuneTop5()
                .doFinally( last -> serviceCallCompleted.set(true) ).toStream().forEach(companyList::add);//todo: change this line only
        ;
